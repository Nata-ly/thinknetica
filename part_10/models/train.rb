...
class Train
  ...
  attr_reader :number, :speed, :station, :type, :list_wagons, :train
  attr_accessor :station_index

  attr_accessor_with_history :h1, :h2, :h3

  strong_attr_accessor :s1, Integer
  strong_attr_accessor :s2, String
